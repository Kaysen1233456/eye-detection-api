...
BATCH_SIZE=256
BASE_LR=1e-5
CHECKPOINT_FILE_PATH=/yszhuo/projects/video_classification_hf/code/workspace3_UniFormerV2/result/b16_f16_224_close_eyes_2class/best.pyth
...
CUDA_VISIBLE_DEVICES=0 python tools/run_net_multi_node.py \
  ...
  RNG_SEED 6666 \
  OUTPUT_DIR ./result/test/b16_f16_224_close_eyes_2class/hf_86041_dms_2class
