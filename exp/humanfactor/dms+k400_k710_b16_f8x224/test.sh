...
CUDA_VISIBLE_DEVICES=0 python tools/run_net_multi_node.py \
  ...
  DATA.PATH_TO_DATA_DIR_VAL /yszhuo/projects/video_fatigue/workspace1_DFER-CLIP/data/20250618/tianan_to_dms/process_json/tianan_eyes_closed_and_non_fatigue_looking_down.json \
  ...
  LAST_FRAMES False \
  EVALUATE False \
  OUTPUT_DIR ./result/try/test/dms_face_clip-k400_k710_pretrain_b16_f8_224-2class/tianan_to_dms
